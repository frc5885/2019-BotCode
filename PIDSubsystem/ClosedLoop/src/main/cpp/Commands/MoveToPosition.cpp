...
void MoveToPosition::Execute() 
{
    ...
    if (Robot::controllerState->GetButtonA() && m_setPoint != 1000000.0)
    {
        // set initial setpoint to tx angle from limelight
        Robot::positionController->SetSetpointRelative(
            Robot::visionNetworkTable->GetNumber("tx", 0.0));
