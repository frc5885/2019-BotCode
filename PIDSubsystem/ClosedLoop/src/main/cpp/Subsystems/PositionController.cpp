...
PositionController::PositionController() : PIDSubsystem("PositionController", .02, 0.0, 0.0175) //0.04
{
    ...
    talonSRX6.reset(new WPI_TalonSRX(3));
    encoder.reset(new frc::Encoder(2, 3, false, frc::Encoder::k4X));

    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=DECLARATIONS
    talonSRX5.reset(new WPI_TalonSRX(4));
    talonSRX7.reset(new WPI_TalonSRX(1));
    talonSRX8.reset(new WPI_TalonSRX(2));
