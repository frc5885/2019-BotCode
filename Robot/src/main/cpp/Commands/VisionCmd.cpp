...
void VisionCmd::Execute() {
    ...
    {
        //Robot::controllerState1->SetRumbles()
        if (Robot::visionNetworkTable->GetNumber("tx", 27) <= 5 && Robot::visionNetworkTable->GetNumber("tx", 27) >= -5)
        {
            Robot::controllerState1->SetRumbles(1, 0.5);
        }
    }
